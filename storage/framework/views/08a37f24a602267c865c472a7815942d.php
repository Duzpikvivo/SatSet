...
<section class="hero">
  ...
  <div class="hero-actions">
    <a href="<?php echo e(route('kontak')); ?>" class="btn-primary">Pesan Servis Sekarang</a>
    <a href="<?php echo e(route('layanan.index')); ?>" class="btn-outline">Lihat Semua Layanan</a>
  </div>
...
</section><?php /**PATH C:\Laravell\service-ac\resources\views/partials/hero.blade.php ENDPATH**/ ?>