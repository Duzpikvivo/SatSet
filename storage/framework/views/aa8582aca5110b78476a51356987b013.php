...
<?php $__env->startSection('title', 'Paket Harga'); ?>
<?php $__env->startSection('meta_description', 'Harga jasa service AC ArcticFix yang transparan. Mulai Rp 150.000 per unit, sudah termasuk biaya kunjungan teknisi.'); ?>
...
<?php $__env->startSection('content'); ?>
  ...
  <section style="background: var(--cream);">
    ...
    <div class="harga-grid">
      ...
      <div class="harga-card">
        ...
        <a href="<?php echo e(route('kontak')); ?>?paket=standar" class="btn-outline" style="width:100%;text-align:center;color:var(--navy);border-color:var(--border);">
          Pesan Paket Ini
        </a>
      </div>
      ...
      <div class="harga-card featured">
        ...
        <a href="<?php echo e(route('kontak')); ?>?paket=lengkap" class="btn-primary" style="width:100%;text-align:center;">
          Pesan Paket Ini
        </a>
      </div>
      ...
      <div class="harga-card">
        ...
        <a href="<?php echo e(route('kontak')); ?>?paket=tahunan" class="btn-outline" style="width:100%;text-align:center;color:var(--navy);border-color:var(--border);">
          Pesan Paket Ini
        </a>
      </div>
  ...
  <section style="background: white;">
    ...
    <div class="harga-elektronik-grid">
      ...
      <div class="harga-el-card">
        ...
        <a href="<?php echo e(route('layanan.show', 'kulkas')); ?>" class="all-card-link" style="margin-top:12px;">Detail layanan</a>
      </div>
      ...
      <div class="harga-el-card">
        ...
        <div class="harga-el-price">Rp 150.000</div>
        <div class="harga-el-note">mulai dari</div>
        <a href="<?php echo e(route('layanan.show', 'mesin-cuci')); ?>" class="all-card-link" style="margin-top:12px;">Detail layanan</a>
      </div>
      ...
      <div class="harga-el-card">
        ...
        <div class="harga-el-price">Rp 150.000</div>
        <div class="harga-el-note">mulai dari</div>
        <a href="<?php echo e(route('layanan.show', 'televisi')); ?>" class="all-card-link" style="margin-top:12px;">Detail layanan</a>
      </div>
      ...
      <div class="harga-el-card">
        ...
        <div class="harga-el-price">Rp 150.000</div>
        <div class="harga-el-note">mulai dari</div>
        <a href="<?php echo e(route('layanan.show', 'water-heater')); ?>" class="all-card-link" style="margin-top:12px;">Detail layanan</a>
      </div>
      ...
      <div class="harga-el-card">
        ...
        <div class="harga-el-price">Rp 150.000</div>
        <div class="harga-el-note">mulai dari</div>
        <a href="<?php echo e(route('layanan.show', 'microwave')); ?>" class="all-card-link" style="margin-top:12px;">Detail layanan</a>
      </div>
      ...
      <div class="harga-el-card" style="background: var(--navy); border-color: var(--navy);">
        ...
        <a href="<?php echo e(route('kontak')); ?>" class="btn-primary" style="margin-top:16px; display:block; text-align:center; font-size:12px; padding: 10px 20px;">
          Tanya Sekarang
        </a>
      </div>
  ...
  <?php echo $__env->make('partials.cta-hubungi', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Laravell\service-ac\resources\views/pages/harga.blade.php ENDPATH**/ ?>